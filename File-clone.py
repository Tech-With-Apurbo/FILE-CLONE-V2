...
os.system('xdg-open https://youtube.com/@TechWithApurbo/')
...
\x1b[1;92m▝▘ ▝▘▝▘    ▝▀▘ ▝▘ ▝▀▝▀▀▀  ▝▀▘
----------------------------------------------
 Author    : Tech With Apurbo
 Github    : Tech With Apurbo
 YOUTUBE   : Tech With Apurbo
 FB Page : Tech With Apurbo
 Tool Name : FILE-CLONE-V2 
 Version   : 0.2
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://youtube.com/@TechWithApurbo6210');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://youtube.com/@TechWithApurbo6210/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://youtube.com/@tbbTechWithApurbo="
